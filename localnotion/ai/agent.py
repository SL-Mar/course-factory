"""AI agent with tool-using capabilities for LocalNotion operations."""
...
SYSTEM_PROMPT = """You are LocalNotion AI, a knowledge management assistant.
...
class Agent:
    """Tool-using AI agent for LocalNotion."""
