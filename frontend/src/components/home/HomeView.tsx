          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {workspaces.map((ws) => (
              <button
                ...
                className="home-tile group relative flex flex-col items-start p-5 rounded-xl border border-content-border/50 bg-content-secondary hover:border-accent/40 transition-all duration-200 text-left min-h-[120px]"
                style={{
                  background: `linear-gradient(135deg, ${ws.color}12 0%, ${ws.color}06 100%)`,
                }}
              >
                {/* Icon */}
