...
class MarkdownImporter:
    """Import a directory of markdown files into Katja."""
    ...
    def _import_file(self, file_path: Path, workspace: str, root: Path) -> None:
        ...
        # Try to parse as Katja page with frontmatter
        try:
        ...
        # Convert Obsidian [[links]] to Katja format (already compatible)
        # Obsidian uses [[Note Name]], Katja uses the same syntax
