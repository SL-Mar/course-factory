...
_DEFAULT_DATA_DIR = Path.home() / "katja"
_DEFAULT_CONFIG_DIR = Path.home() / ".config" / "katja"
...
class Settings(BaseSettings):
    ...
    Resolution order (last wins):
      1. Field defaults
      2. ``.env`` file
      3. Environment variables (``KJ_`` prefix)
    ...
    # ── licence / identity ──────────────────────────────────────────────
    license_key: str = Field(default="", description="Katja licence key (KJ- prefix)")

    # ── data directory ──────────────────────────────────────────────────
    data_dir: Path = Field(
        default=_DEFAULT_DATA_DIR,
        description="Root data directory (~/katja/)",
    )
