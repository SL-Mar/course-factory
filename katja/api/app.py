...
from katja.api.routers.pages import router as pages_router
from katja.api.routers.tables import router as tables_router
from katja.api.routers.graph import router as graph_router
from katja.api.routers.ai import router as ai_router
from katja.api.routers.engines import router as engines_router
from katja.api.routers.imports import router as imports_router
from katja.api.routers.setup import router as setup_router
from katja.api.routers.assets import router as assets_router
...
async def startup() -> None:
    ...
    try:
        ...
        from katja.core.seed import seed_if_empty
            ...
            async with aiohttp.ClientSession() as session:
                ...
                if resp.status == 200:
                    ...
                    if count == 0:
                        ...
                        from katja.api.routers.pages import _run_reindex
