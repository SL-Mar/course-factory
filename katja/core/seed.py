"""Seed starter content for a fresh Katja install."""
...
Katja keeps everything on your machine — no cloud, no sync delays, no subscriptions.
Every page is a plain Markdown file in `~/katja/pages/`.
...
|---------|--------|----------|-------|-----|
| Katja v1.0 | In Progress | High | Team | Q1 2026 |
...
How to build and organize your personal knowledge system with Katja.

## The Zettelkasten Method

Katja is built around the *Zettelkasten* (slip-box) method:
...
Long-term planning for Katja development.
...
Essential Katja shortcuts and Markdown syntax.
...
For more tips, see [[Knowledge Base]] and [[Welcome to Katja]].
""", favorite=True))
